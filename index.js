...
/* harmony import */ var ts_cookies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _urls__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _thread__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22);
...
class FC {
    static async getUserData(id) {
        return new _user__WEBPACK_IMPORTED_MODULE_5__["User"](id).get();
    }
    static async getThreadData(id) {
        return new _thread__WEBPACK_IMPORTED_MODULE_4__["Thread"](id).get();
    }
    static async getCurrentUserId(force_update = false) {
        const isLoggedIn = ts_cookies__WEBPACK_IMPORTED_MODULE_0__["default"].get('bbsessionhash') !== undefined;
        if (isLoggedIn === false)
            return -1;
        if (FC.currentUserId !== null && force_update !== true)
            return FC.currentUserId;
        return fetch(_urls__WEBPACK_IMPORTED_MODULE_1__["Urls"].usercp.href)
            .then(_utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].responseToHtml)
            .then(html => {
    ...
    static async getCurrentUser() {
        return new _user__WEBPACK_IMPORTED_MODULE_5__["CurrentUser"]().get();
    }
    static async getSecurityToken() {
        if (this.currentToken === null) {
            const rawToken = await fetch(_urls__WEBPACK_IMPORTED_MODULE_1__["Urls"].onlineUsers.href)
                .then(_utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].responseToHtml)
                .then(html => {
                return html.querySelector('[name="securitytoken"]').value;
            });
            this.currentToken = new _token__WEBPACK_IMPORTED_MODULE_3__["Token"](rawToken);
        }
    ...
    static async searchForPartialNickname(nicknameFragment) {
        ...
        return fetch(_urls__WEBPACK_IMPORTED_MODULE_1__["Urls"].userSearch.href, {
            method: 'POST',
            body: form
        }).then(_utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].responseToHtml)
            .then(xml => {
            ...
            return userTags.map((userTag) => {
                return _user__WEBPACK_IMPORTED_MODULE_5__["BasicUser"].fromHTML(userTag);
            });
        });
    }
}
...
FC.Urls = _urls__WEBPACK_IMPORTED_MODULE_1__["Urls"];
FC.Utils = _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"];
...
/* harmony import */ var superagent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
...
class Token {
    ...
    async update() {
        if (this.isGuest())
            return;
        const newRawToken = superagent__WEBPACK_IMPORTED_MODULE_0___default.a.post(_urls__WEBPACK_IMPORTED_MODULE_1__["Urls"].ajax.href)
            .send(`securitytoken=${this.getRawToken()}&do=securitytoken`)
            .then((response) => _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].parseHTML(response.text)).then(doc => {
...
var safeStringify = __webpack_require__(8);
...
/* harmony import */ var _urls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _dynamic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21);
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);
...
__decorate([
    _dynamic__WEBPACK_IMPORTED_MODULE_2__["Dynamic"].DynamicLock,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dynamic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
...
/* harmony import */ var _dynamic_lock__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
...
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
...
/* harmony import */ var _dynamic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _user_abouts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
...
/* harmony import */ var _user_stats__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(24);
...
/* harmony import */ var _basic_user__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
...
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26);
...
/* harmony import */ var _current_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
...
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _dynamic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _user_stats__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24);
/* harmony import */ var _user_abouts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26);
/* harmony import */ var _basic_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(25);
